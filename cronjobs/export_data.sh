...
case ${1^^} in
  ...
  JP)
    ...
    DADGUIDE_ZIP_DB_FILE="${DADGUIDE_GAME_DB_DIR}/v2_dadguide_jp.sqlite.zip";
    DADGUIDE_MYSQL_FILE="${DADGUIDE_GAME_DB_DIR}/dadguide_jp.mysql";
  ...
  NA)
    ...
    DADGUIDE_ZIP_DB_FILE="${DADGUIDE_GAME_DB_DIR}/v2_dadguide_na.sqlite.zip";
    DADGUIDE_MYSQL_FILE="${DADGUIDE_GAME_DB_DIR}/dadguide_na.mysql";
  ...
  KR)
    ...
    DADGUIDE_ZIP_DB_FILE="${DADGUIDE_GAME_DB_DIR}/v2_dadguide_kr.sqlite.zip";
    DADGUIDE_MYSQL_FILE="${DADGUIDE_GAME_DB_DIR}/dadguide_kr.mysql";
