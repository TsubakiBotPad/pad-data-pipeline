...
"""
__import__("sys").path.append("/Users/chasehult/apps/fork/dadguide-data/etl")
__import__("os").chdir("..")
import argparse
import difflib
import json
...
if __name__ == '__main__':
    #args = parse_args()
    args = argparse.Namespace(input_dir='pad_data/raw', output_dir='pad_data/integration')
    run_test(args)
