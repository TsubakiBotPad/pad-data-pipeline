...
from pad.raw.skills.enemy_skill_info import ESInstance, ESUseSkillset
...
def behavior_to_proto(instance: ESInstance, is_timed_group=True, cur_hp=100) -> BehaviorItem:
    ...
    if cond is not None:
        ...
        item_condition.damage_done = cond.damage_done or 0
        item_condition.attributes_attacked.extend(cond.attributes_attacked)
        item_condition.skills_used = cond.skills_used or 0
