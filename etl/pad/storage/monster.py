...
class Monster(SimpleSqlItem):
    ...
    def from_csm(o: CrossServerCard) -> 'Monster':
        ...
        extra_latent_slot = jp_card.latent_slot_unlock_flag
        ...
        return Monster(
            ...
            extra_latent_slot=extra_latent_slot)
    ...
    def __init__(self,
        ...
        self.extra_latent_slot = extra_latent_slot
        self.tstamp = tstamp
